                            ...
                            [
                                dbc.Col(
                                    children=[
                                        ...
                                        html.Div(
                                            children=[
                                                dcc.Link(dbc.Button("START", color="primary", className="start-button"), href="/app", refresh=True),
                                ...
                                dbc.Col(
                                    children=[
                                        #html.P("Example")
                                        html.Img(src=r'assets/home_screen.png', alt='image', className="main_figure")
                                    ],
                                    width=6,
                    ...
                    html.A(
                        ...
                        dbc.Row(
                            [
                                ...
                                dbc.Col(dbc.NavbarBrand("Multiobjective Optimization Group - Phone selection tool", className="ms-2")),
                            ],
                            align="center",
                            className="g-0",
                        ),
                        ...
                        dbc.Card(
                            children=[
                                ...
                                dbc.CardBody(
                                    ...
                                    style={"maxHeight": "560px", "overflow": "hidden"},
                                    ...
                                    children = [
                                        dbc.Col(
                                            ...
                                            children = [
                                                ...
                                                html.Div(id="figure-result", style={"align-items":"center", "padding":"1em"})
                                            ],
                                            width=4,
                                        ),
                                        dbc.Col(
                                        ...
                                        [
                                                dbc.Row(
                                                    children=[
                                                        dbc.Col(
                                                            children=[
                                                            dbc.Row(html.Div(id=f"figure-option-{i}")),
                                                            dbc.Row(html.Span(
                                                            f"{i}. ",
...
def results(*choices):
    ...
    if total_number >= 4:
        others, tooltips, figures = other_options(card_data.loc[distance_order.values[1:5]])
    else:
    ...
    idresult = html.Div(html.Img(src=app.get_asset_url(f"images/{id}.jpg"), style={'width':'70%'}))
...
def get_figures_options(id):
    return html.Div(html.Img(src=app.get_asset_url(f"images/{id}.jpg"), style={'width':'70%'}))
